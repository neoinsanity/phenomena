...
htmlhelp_basename = 'Phenomenadoc'
...
latex_documents = [
    ('index', 'Phenomena.tex', u'Phenomena Documentation',
...
man_pages = [
    ('index', 'Phenomena', u'Phenomena Documentation',
     [u'Raul Gonzalez'], 1)
]
...
texinfo_documents = [
    ('index', 'k', u'Phenomena Documentation',
     u'Raul Gonzalez', 'Phenomena', 'Event Service.',
     'Miscellaneous'),
]
